const Footer = () => (
  <footer className="bg-stone-950 text-white p-8 mt-12 shadow-inner">
    ...
    <div className="container mx-auto text-center">
      ...
      <div className="flex justify-center space-x-6 text-2xl">
        {/* Facebook Icon */}
        <a href="https://www.facebook.com/yourdancestudio" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-500 transition duration-300">
          <i className="fab fa-facebook"></i>
        </a>
        {/* Instagram Icon */}
        <a href="https://www.instagram.com/yourdancestudio" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-pink-500 transition duration-300">
          <i className="fab fa-instagram"></i>
        </a>
        {/* TikTok Icon */}
        <a href="https://www.tiktok.com/@yourdancestudio" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-black transition duration-300">
