  ...
  <footer className="bg-[#272727] text-white p-6 md:p-8 shadow-inner">
    <div className="container mx-auto text-center">
      ...
      <div className="flex justify-center space-x-4 md:space-x-6 text-xl md:text-2xl">
        {/* Facebook Icon */}
        <a href="https://www.facebook.com/share/1EsEF9HZAp/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-500 transition duration-300" aria-label="Facebook">
          <FontAwesomeIcon icon={faFacebook} />
        </a>
        {/* Instagram Icon */}
        <a href="https://www.instagram.com/studio_dance_core/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-pink-500 transition duration-300" aria-label="Instagram">
