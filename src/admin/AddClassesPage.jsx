  ...
  const handleDelete = () => {
    if (confirm('Are you sure you want to delete this class?')) { // Using confirm for demo, replace with proper UI feedback
      ...
      setClassData({ // Clear form after delete
        image: '', className: '', date: '', location: '', classFees: '', time: '', description: '', status: 'active',
      });
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleAdd} className="space-y-4">
        ...
        <div>
          <label htmlFor="classFees" className="block text-sm font-medium text-gray-700 mb-1">Class Fee (LKR)</label>
          <input
            type="number"
            id="classFees"
            name="classFees"
        ...
        <div>
          <label htmlFor="classInstructor" className="block text-sm font-medium text-gray-700 mb-1">Class Instructor</label>
          <input
            type="text"
            id="classInstructor"
            name="classInstructor"
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
            placeholder="e.g., Mr.Jayaruwan"
            value={classData.classInstructor}
            onChange={handleChange}
            required
          />
        </div>
        <div>
          <label htmlFor="dancingStyle" className="block text-sm font-medium text-gray-700 mb-1">Dancing Style</label>
          <input
            type="text"
            id="dancingStyle"
            name="dancingStyle"
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
            placeholder="e.g., Western Dancing"
            value={classData.dancingStyle}
            onChange={handleChange}
            required
          />
        </div>
